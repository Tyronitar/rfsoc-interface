"""Create data for testing code."""

import numpy as np
from kidpy3 import RawDataFile

from rfsocinterface.core.data import ConsolidatedData


def make_tod():
    """Make a fake TOD file for testing."""
    old = RawDataFile(
        '/data/20260617/20260617_Device_aSi2_Channel3_telescope_275mK_20260511_with_offres_and_max_power_TOD_set1005.h5',
        'r',
    )
    data = RawDataFile(
        'tests/test_data/20260709/20260709_Test_Tile_TOD_set1001.h5', 'w'
    )
...
def make_processed_data():
    ...
    cdata = ConsolidatedData.from_tod(
        '20260709', '1001', data_dir='tests/test_data', downsampling_factor=5
    )
    cdata.create_processed_data()
