...
if __name__ == '__main__':
    ...
    detector_f = pdata.get_detector_f(0)
    data_IQ = pdata.get_data_IQ(0)
    data_freq_diss = pdata.get_data_freq_diss(0)
    IQ_to_freq_diss_angle = pdata.get_IQ_to_freq_diss_angle(0)
    adc_units_to_hz = pdata.get_adc_units_to_hz(0)
    ...
    good_res = pdata.get_onres_ind(0)
