...
from rfsocinterface.gui.widgets.image_label import ImageLabel
...
class Ui_TelescopeControlWidget(object):
    def setupUi(self, TelescopeControlWidget):
        ...
        TelescopeControlWidget.resize(1041, 510)
        ...
        sizePolicy1.setHeightForWidth(self.camera_settings_groupBox.sizePolicy().hasHeightForWidth())
        self.camera_settings_groupBox.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.exposure_mode_comboBox.sizePolicy().hasHeightForWidth())
        self.exposure_mode_comboBox.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.exposure_time_lineEdit.sizePolicy().hasHeightForWidth())
        self.exposure_time_lineEdit.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_2.addWidget(self.camera_settings_groupBox, 1, 1, 3, 1)
        ...
        sizePolicy3.setHeightForWidth(self.stop_pushButton.sizePolicy().hasHeightForWidth())
        self.stop_pushButton.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.control_groupBox.sizePolicy().hasHeightForWidth())
        self.control_groupBox.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.position_groupBox.sizePolicy().hasHeightForWidth())
        self.position_groupBox.setSizePolicy(sizePolicy4)
        ...
        self.optical_label = ImageLabel(TelescopeControlWidget)
        self.optical_label.setObjectName(u"optical_label")
        sizePolicy5 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Ignored)
        sizePolicy5.setHorizontalStretch(0)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.optical_label.sizePolicy().hasHeightForWidth())
        self.optical_label.setSizePolicy(sizePolicy5)
        self.optical_label.setMinimumSize(QSize(0, 0))
        self.optical_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout_2.addWidget(self.optical_label, 2, 0, 2, 1)
