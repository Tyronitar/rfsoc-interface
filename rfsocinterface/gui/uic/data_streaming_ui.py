...
class Ui_DataStreamingWidget(object):
    def setupUi(self, DataStreamingWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 437, 233))
        ...
        self.gridLayout_2.addWidget(self.channel_comboBox, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.start_pushButton, 2, 1, 1, 1)

        self.data_routines_pushButton = QPushButton(DataStreamingWidget)
        self.data_routines_pushButton.setObjectName(u"data_routines_pushButton")

        self.gridLayout.addWidget(self.data_routines_pushButton, 1, 1, 1, 1)
    ...
    def retranslateUi(self, DataStreamingWidget):
        ...
        self.data_routines_pushButton.setText(QCoreApplication.translate("DataStreamingWidget", u"Data Routines...", None))
    # retranslateUi
