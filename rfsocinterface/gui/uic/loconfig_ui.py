...
class Ui_LoConfigWidget(object):
    def setupUi(self, LoConfigWidget):
        ...
        self.lo_gridLayout.addLayout(self.highres_sweep_horizontalLayout, 12, 1, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.save_plots_CheckBox, 9, 2, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.highres_sweep_checkBox, 12, 0, 1, 1)

        self.only_flag_checkBox = QCheckBox(self.lo_settings_groupBox)
        self.only_flag_checkBox.setObjectName(u"only_flag_checkBox")

        self.lo_gridLayout.addWidget(self.only_flag_checkBox, 9, 1, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.highres_sweep_save_plots_checkBox, 12, 2, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.review_tones_checkbox, 10, 1, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.groupBox, 8, 0, 1, 3)

        self.upload_checkBox = QCheckBox(self.lo_settings_groupBox)
        self.upload_checkBox.setObjectName(u"upload_checkBox")

        self.lo_gridLayout.addWidget(self.upload_checkBox, 11, 0, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.show_diagnostics_checkBox, 9, 0, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.only_highres_checkBox, 7, 0, 1, 1)
