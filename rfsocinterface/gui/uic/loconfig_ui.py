...
class Ui_LoConfigWidget(object):
    def setupUi(self, LoConfigWidget):
        ...
        self.lo_gridLayout.addWidget(self.second_sweep_checkBox, 10, 0, 1, 1)
        ...
        self.lo_gridLayout.addLayout(self.second_sweep_horizontalLayout, 10, 1, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.upload_checkBox, 9, 0, 1, 1)
