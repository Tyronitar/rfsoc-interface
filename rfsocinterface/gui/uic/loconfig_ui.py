...
class Ui_LoConfigWidget(object):
    def setupUi(self, LoConfigWidget):
        ...
        self.lo_gridLayout.addWidget(self.highres_sweep_checkBox, 11, 0, 1, 1)
        ...
        self.lo_gridLayout.addLayout(self.highres_sweep_horizontalLayout, 11, 1, 1, 1)
        ...
        self.lo_gridLayout.addWidget(self.highres_sweep_save_plots_checkBox, 11, 2, 1, 1)
