...
class Ui_LoConfigWidget(object):
    def setupUi(self, LoConfigWidget):
        ...
        self.buttonGroup.addButton(self.lo_sweep_radioButton)
        ...
        self.buttonGroup.addButton(self.power_sweep_radioButton)
        ...
        self.filename_none_radioButton.setChecked(False)
