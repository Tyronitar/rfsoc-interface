...
class Ui_LoConfigWidget(object):
    def setupUi(self, LoConfigWidget):
        ...
        self.tone_list_label.setBuddy(self.tone_list_lineEdit)
    ...
    def retranslateUi(self, LoConfigWidget):
...
#if QT_CONFIG(tooltip)
        self.tone_list_label.setToolTip(QCoreApplication.translate("LoConfigWidget", u"Choose a list of resonant frequencies", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.tone_list_label.setWhatsThis(QCoreApplication.translate("LoConfigWidget", u"List of tones of resonant frequencies", None))
#endif // QT_CONFIG(whatsthis)
        self.tone_list_label.setText(QCoreApplication.translate("LoConfigWidget", u"Tone list file:", None))
        self.tone_list_pushButton.setText(QCoreApplication.translate("LoConfigWidget", u"Browse...", None))
#if QT_CONFIG(tooltip)
        ...
        self.second_sweep_df_lineEdit.setText(QCoreApplication.translate("LoConfigWidget", u"0.1", None))
