...
if __name__ == '__main__':
    ...
    set_num = 1004
    p = ProcessedData('20250415', set_num, losweep='20250415_rfsoc2_LO_Sweep_hour16p1919.h5')
    # pdb.set_trace()
    ...
    plot_psd(freq, noise_psd, f'plots/20250415_{set_num}.pdf', basis='pa', title='Loopback')
