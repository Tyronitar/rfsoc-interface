...
# OPTCAM_OFFSET_AZ_DEG = 0.698
# OPTCAM_OFFSET_ZA_DEG = -0.05976
# Optical camera offset relative to center of telescope boresight
OPTCAM_OFFSET_AZ_DEG = 3.8887
OPTCAM_OFFSET_ZA_DEG = -1.6557
OPTCAM_OFFSET_AZ_PIX = int(OPTCAM_OFFSET_AZ_DEG / OPTCAM_DPIX)
OPTCAM_OFFSET_ZA_PIX = int(OPTCAM_OFFSET_ZA_DEG / OPTCAM_DPIX)
# OPTCAM_OFFSET_AZ_PIX = 0
# OPTCAM_OFFSET_ZA_PIX = 0
